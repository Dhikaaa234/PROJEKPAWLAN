            ...
            <div class="mb-8 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
              <div>
                ...
                <p class="mt-3 text-base text-slate-600">
                  {{ $t('notifications.admin_description') }}
                </p>
              </div>
              ...
              >
                ...
                <div class="min-w-0">
                  <div class="flex flex-wrap items-center gap-2">
                    <h3
                      class="truncate text-base font-extrabold"
                    ...
                    <span
                      ...
                      class="size-2 shrink-0 rounded-full bg-blue-700"
                    ></span>
                  </div>
                ...
                <p
                  class="text-left text-sm font-bold md:text-right"
                  :class="notification.unread ? 'text-blue-700' : 'text-slate-500'"
                >
                  {{ notification.time }}
                </p>
              </article>
          ...
          <div class="px-6 py-6">
            <div class="mb-4 flex flex-wrap items-center gap-2">
              ...
              <p
                ...
                class="inline-flex rounded-full bg-blue-50 px-3 py-1 text-xs font-extrabold text-blue-700"
              >
                {{ $t('common.unread') }}
              </p>
            </div>
