...
function getCategoryOptionLabel(category) {
  return category === 'Semua Kategori' ? t('reports.all_categories') : category
}
          ...
          <section class="mx-auto max-w-[1280px]">
            <div class="mb-8">
              <h1 class="text-4xl font-extrabold tracking-tight text-slate-950 md:text-5xl">
                {{ $t('admin.management_title') }}
              </h1>
              <p class="mt-3 text-base text-slate-600 md:text-lg">
                {{ $t('admin.management_description') }}
              </p>
            </div>
              ...
              <div class="grid gap-3 lg:grid-cols-[minmax(0,1fr)_180px_240px]">
                <label class="relative">
                  ...
                  <input
                    ...
                    type="search"
                    :placeholder="$t('reports.search_admin_placeholder')"
            ...
            <section class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
                    ...
                    >
                      <td class="px-7 py-6">
                        <button
                          ...
                          :aria-label="
                            report.imageUrl
                              ? `${$t('admin.preview_photo')} ${report.title}`
                              : `${$t('admin.photo')} ${report.title}`
                          "
                        >
                          <img
                      ...
                      <td class="px-7 py-6">
                        <div class="flex items-center justify-center">
                          <button
                            ...
                            :aria-label="$t('admin.change_status_aria', { title: report.title })"
                          >
              ...
              >
                <p class="text-sm font-medium text-slate-500">
                  {{ $t('common.showing') }} {{ paginatedReports.length }} {{ $t('common.of') }} {{ totalReports }} {{ $t('common.reports') }}
                </p>
    ...
    >
      <div class="w-full max-w-[620px] rounded-2xl bg-white shadow-[0_20px_60px_rgba(15,23,42,0.22)]">
        ...
        <div class="space-y-5 px-6 py-6">
          ...
          >
            <div class="grid gap-4 p-4 sm:grid-cols-[120px_1fr]">
              ...
              <div class="min-w-0">
                ...
                >
                  {{ $t('admin.reported_by') }} {{ selectedReport.reporter }} / {{ selectedReport.location }}
                </p>
          ...
          <div>
            ...
            <textarea
              ...
              v-model="adminNote"
              rows="4"
              :placeholder="$t('admin.admin_note_placeholder')"
        ...
        <div class="flex flex-col gap-3 border-t border-slate-200 px-6 py-5 sm:flex-row sm:justify-end">
          ...
          >
            {{ isSavingStatus ? $t('common.saving') : $t('admin.save_changes') }}
          </button>
        </div>
      </div>
    </div>
      ...
      <div class="w-full max-w-[900px] overflow-hidden rounded-2xl bg-white shadow-[0_20px_70px_rgba(15,23,42,0.32)]">
        <div class="flex items-center justify-between gap-4 border-b border-slate-200 px-6 py-5">
          ...
          <button
            ...
            :aria-label="$t('common.close_photo_preview')"
          >
            <X :size="21" />
          </button>
        </div>
