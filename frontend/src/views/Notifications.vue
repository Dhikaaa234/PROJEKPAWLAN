...
// Menu items dengan terjemahan dinamis
        ...
        >
          <div class="mb-8 flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xs font-extrabold uppercase tracking-wide text-blue-700">{{ t.facility_management }}</p>
            </div>
          </div>
          <nav class="space-y-2">
            <button
        ...
        <main class="px-5 py-5 md:px-8 lg:px-10">
          <section class="mx-auto max-w-[1280px]">
            <div class="mb-8 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
              <div>
                <h1 class="text-3xl font-extrabold tracking-tight text-slate-950 md:text-4xl">{{ t.notifications }}</h1>
                <p class="mt-3 text-base text-slate-600">{{ t.notifications_desc }}</p>
              </div>
            ...
            <section class="overflow-hidden rounded-xl border border-slate-300 bg-white shadow-sm">
              ...
              >
                ...
                <div>
                  <div class="flex flex-wrap items-center gap-2">
                    <h3 class="text-base font-extrabold" :class="notification.unread ? 'text-slate-950' : 'text-slate-700'">
                      {{ notification.title }}
                    </h3>
                    <span v-if="notification.unread" class="size-2 rounded-full bg-blue-700"></span>
                  </div>
              ...
              <div v-if="allNotifications.length === 0 && !isLoadingNotifications" class="px-6 py-12 text-center">
        ...
        <div class="w-full overflow-hidden rounded-2xl bg-white shadow-[0_20px_70px_rgba(15,23,42,0.28)]">
          <div class="flex items-start justify-between gap-4 border-b border-slate-200 px-6 py-5">
            <div class="flex items-start gap-4">
              ...
              <div>
                <h2 class="text-xl font-extrabold leading-tight text-slate-950">{{ t.notification_detail }}</h2>
